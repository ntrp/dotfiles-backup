...
vim.cmd('nmap <C-S-w> <Plug>(vsnip-cut-text)')
vim.cmd('xmap <C-S-w> <Plug>(vsnip-cut-text)')
vim.cmd('smap <C-S-w> <Plug>(vsnip-cut-text)')


vim.api.nvim_set_keymap('n', '<C-s>', ':w<CR>', {silent = false})
vim.api.nvim_set_keymap('n', '<C-S-s>', ':wa<CR>', {silent = false})
