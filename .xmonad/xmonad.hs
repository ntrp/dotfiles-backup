...
myFont :: String
myFont = "xft:SauceCodePro Nerd Font Mono:regular:size=32:antialias=true:hinting=true"
...
myScratchPads = [ NS "terminal" spawnTerm findTerm manageTerm
  ...
  where
    spawnTerm  = myTerminal ++ " -t term -e tmux new-session -A -s term"
    findTerm   = title =? "term"
...
myWorkspaces = ["www", "msg", "dev", "ex1", "ex2"]
...
myKeys =
    ...
    -- Kill windows
        ...
        , ("M-S-<Delete>", killAll)   -- Kill all windows on current workspace
